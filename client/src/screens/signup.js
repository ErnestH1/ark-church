...
import Logo1 from '../assets/logo-07.png'

function Signup() {
  // Fetch here the data from the API
      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <p className="text-xs mt-4 text-[#002D74]">Welcome to the Ark Youth Church</p>
            {/* Form start here */}
            <form action="" method='post' className="flex flex-col gap-4">
              <input className="p-2 mt-4 rounded-xl border" type="text" name="text" placeholder="Full name" />
              <input className="p-2 mt-4 rounded-xl border" type="tel" name="telephone" placeholder="Phone number" />
            ...
            {/* Login google button start here */}
          ...
          <div className="md:block hidden w-1/2 ">
            <Link to="/">
              <img className="rounded-2xl" src={Logo1} alt='logo' />
            </Link>
          </div>
        </div>
      </section>
